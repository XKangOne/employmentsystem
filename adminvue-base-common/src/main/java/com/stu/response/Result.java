...
public class Result {
    ...
    public static Result alreadyexists(){
        ...
        result.setCode(ResultCode.ALREADYEXISTS.getCode());
        result.setMessage(ResultCode.ALREADYEXISTS.getMessage());
        return result;
    }
    ...
    public Result alreadyexists(Boolean alreadyexists){
