...
import com.stu.exception.ServiceException;
...
public class JwtUtil {
     ...
     */
    private static final String KEY = "ykk";

    public static String createToken(String stel, String spwd) {
...
//        DateTime expTime = now.offsetNew(DateField.SECOND, 100000);
        ...
        // 内容
        payload.put("stel", stel);
        payload.put("spwd", spwd);
...
////        String token = createToken(1, "ykk");
